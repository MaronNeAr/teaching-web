<template>
  <div class="container">
    <div class="handle-box">
      ...
      <el-button v-if="!sorted" @click="sorted =! sorted" style="primary">按成绩倒序</el-button>
      <el-button v-if="sorted" @click="sorted =! sorted" style="primary">恢复原数据</el-button>
...
export default defineComponent({
  ...
  setup() {
    ...
    const data = computed(() => {
      ...
      if (sorted.value) table.sort((o1, o2) => (o2.score - o1.score));
      return table.slice((currentPage.value - 1) * pageSize.value, currentPage.value * pageSize.value);
    });
